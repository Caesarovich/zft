...
fn test_lstmap_empty_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_lstmap_single_fn(_: std.mem.Allocator) TestCaseError!void {
    var value: u8 = 21;
    var node: c.t_list = .{
        .content = &value,
        .next = null,
...
fn test_lstmap_multiple_fn(_: std.mem.Allocator) TestCaseError!void {
    var value1: u8 = 1;
    var value2: u8 = 2;
    var value3: u8 = 3;
...
fn test_lstmap_strings_fn(_: std.mem.Allocator) TestCaseError!void {
    const str1 = "hello";
    const str2 = "world";
...
fn test_lstmap_counter_fn(_: std.mem.Allocator) TestCaseError!void {
