...
fn test_lstsize_empty_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_lstsize_single_fn(_: std.mem.Allocator) TestCaseError!void {
    const value: u8 = 42;
...
fn test_lstsize_multiple_fn(_: std.mem.Allocator) TestCaseError!void {
