...
fn test_lstclear_empty_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_lstclear_single_fn(_: std.mem.Allocator) TestCaseError!void {
    clear_delete_call_count = 0;
...
fn test_lstclear_multiple_fn(_: std.mem.Allocator) TestCaseError!void {
    clear_delete_call_count = 0;
