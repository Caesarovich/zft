...
fn test_striteri_uppercase_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
...
fn test_striteri_add_index_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
...
fn test_striteri_replace_all_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
    var test_str = [_]u8{ 'H', 'e', 'l', 'l', 'o', 0 };
...
fn test_striteri_empty_string_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
    var test_str = [_]u8{0};
...
fn test_striteri_single_char_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
...
fn test_striteri_mixed_case_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
    var test_str = [_]u8{ 'H', 'e', 'L', 'L', 'o', 0 };
...
fn test_striteri_special_chars_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
...
fn test_striteri_null_string_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
...
fn test_striteri_null_function_fn(_: std.mem.Allocator) TestCaseError!void {
    reset_call_tracking();
    var test_str = [_]u8{ 'h', 'e', 'l', 'l', 'o', 0 };
