...
fn test_strmapi_uppercase_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_add_index_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_replace_all_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_empty_string_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_single_char_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_mixed_case_fn(_: std.mem.Allocator) TestCaseError!void {
    const result = ft_strmapi("HeLLo", to_upper);
    try assert.expect(result != null, "ft_strmapi should return a valid pointer");
    if (result) |str| {
        try assert.expect(c.strcmp(str, "HELLO") == 0, "Expected 'HELLO'");
...
fn test_strmapi_special_chars_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_null_string_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_strmapi_null_function_fn(_: std.mem.Allocator) TestCaseError!void {
