...
fn test_itoa_zero_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_positive_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_negative_fn(_: std.mem.Allocator) TestCaseError!void {
    const result = ft_itoa(-42);
    try assert.expect(result != null, "ft_itoa should return a valid pointer");
    if (result) |str| {
        try assert.expect(c.strcmp(str, "-42") == 0, "Expected '-42'");
...
fn test_itoa_int_max_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_int_min_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_single_digit_pos_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_single_digit_neg_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_large_positive_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_large_negative_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_itoa_multiples_of_ten_fn(_: std.mem.Allocator) TestCaseError!void {
