...
fn test_split_normal_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_consecutive_delims_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_leading_trailing_fn(_: std.mem.Allocator) TestCaseError!void {
    const result = ft_split(",Hello,World,", ',');
    try assert.expect(result != null, "ft_split should return a valid pointer");
    if (result) |split| {
...
fn test_split_no_delims_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_empty_string_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_null_string_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_only_delims_fn(_: std.mem.Allocator) TestCaseError!void {
    const result = ft_split(",,,", ',');
    try assert.expect(result != null, "ft_split should return a valid pointer");
    if (result) |split| {
...
fn test_split_space_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_split_single_char_fn(_: std.mem.Allocator) TestCaseError!void {
