...
fn test_equal_strings_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_first_less_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_first_greater_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_n_less_than_length_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_n_greater_than_length_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_empty_strings_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_zero_n_fn(_: std.mem.Allocator) TestCaseError!void {
...
fn test_non_ascii_fn(_: std.mem.Allocator) TestCaseError!void {
    const str1 = "test\x00";
