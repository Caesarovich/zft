...
fn test_putnbr_fd_zero_fn(_: std.mem.Allocator) AssertError!void {
...
fn test_putnbr_fd_positive_single_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_negative_single_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_positive_multi_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_negative_multi_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_int_max_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_int_min_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_large_positive_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_large_negative_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putnbr_fd_zeros_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
