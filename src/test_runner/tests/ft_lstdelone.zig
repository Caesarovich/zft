...
fn test_lstdelone_with_content_fn(_: std.mem.Allocator) AssertError!void {
    delete_call_count = 0;
...
fn test_lstdelone_null_content_fn(_: std.mem.Allocator) AssertError!void {
    delete_call_count = 0;
...
fn test_lstdelone_with_next_fn(_: std.mem.Allocator) AssertError!void {
    delete_call_count = 0;
