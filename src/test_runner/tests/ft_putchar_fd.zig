...
fn test_putchar_fd_valid_fn(_: std.mem.Allocator) AssertError!void {
...
fn test_putchar_fd_special_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putchar_fd_zero_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putchar_fd_many_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
