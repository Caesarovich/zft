...
fn test_putendl_fd_normal_fn(_: std.mem.Allocator) AssertError!void {
...
fn test_putendl_fd_empty_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putendl_fd_null_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putendl_fd_with_newlines_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putendl_fd_single_char_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putendl_fd_long_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
...
fn test_putendl_fd_special_fn(_: std.mem.Allocator) AssertError!void {
    const fd = create_temp_file() catch return AssertError.AssertionFailed;
    defer _ = c.close(fd);
